...
function ShowConfirm(c) {
    ...
    var j = "<div id='ModalWindowOuter" + k + "' style='width:" + (param.Width + 40) + "px;height:" + (param.Height + 40) + "px;margin-left:" + g + "px;margin-top:" + h + "px' class='popup_block " + param.Class + "'>   <div class='popup_title' style='margin-left:20px;width:" + param.Width + "px;z-index:1001;position:absolute;direction:rtl'>" + param.Title + "</div>   <div onclick=\"$('#ModalWindowOuter" + k + "').remove()\" style='margin-left:" + (g - 15) + "px;margin-top:" + (h - 15) + "px' class='popup_close' ></div>   <div id='ModalWindowInner" + k + "' style='width:" + param.Width + "px;height:" + param.Height + "px;margin-left:" + g + "px;margin-top:" + h + "px' class='popup_inside' >" + param.Desc + "<br/><table style='margin-left:auto;margin-right:auto;'>";
    var a;
    var l = "";
...
function ShowModalStaticPro(h, c, j, b, a) {
    ...
    var d = -(25 + j / 2);
    var e = -(b / 2);
    var f = "<div id='ModalWindowOuter" + g + "' style='width:" + (j + 40) + "px;height:" + (b + 40) + "px;margin-left:" + d + "px;margin-top:" + e + "px' class='popup_block " + ((typeof a != "undefined") ? a : "") + "'>   <div class='popup_title' style='margin-left:20px;width:" + j + "px;z-index:1001;position:absolute;direction:rtl'>" + h + "</div>   <div onclick=\"$('#ModalWindowOuter" + g + "').remove()\" style='margin-left:" + (d - 15) + "px;margin-top:" + (e - 15) + "px' class='popup_close' ></div>   <div id='ModalWindowInner" + g + "' style='width:" + j + "px;height:" + b + "px;margin-left:" + d + "px;margin-top:" + e + "px' class='popup_inside' >" + c + "   </div></div>";
...
function ShowModalWindow(h, j, b, a) {
    ...
    if (c == null) {
        ...
        var d = -(25 + j / 2);
        var e = -(b / 2);
        var f = "<div id='ModalWindowOuter" + g + "' style='width:" + j + "px;height:" + b + "px;margin-left:" + d + "px;margin-top:" + e + "px' class='popup_block " + ((typeof a != "undefined") ? a : "") + "'>   <div onclick=\"$('#ModalWindowOuter" + g + "').remove()\" style='margin-left:" + (d - 15) + "px;margin-top:" + (e - 15) + "px' class='popup_close' ></div>   <div id='ModalWindowInner" + g + "' style='width:" + j + "px;height:" + b + "px;margin-left:" + d + "px;margin-top:" + e + "px' class='popup_inside' >   </div></div>";
        $(document.body).append(f);
        $.ajax({
            url: h,
            cache: true,
...
function ShowModalFrame(f, g, a) {
    ...
    var b = -(25 + g / 2);
    var c = -(a / 2);
    var d = "<div id='ModalWindowOuter" + e + "' style='width:" + g + "px;height:" + a + "px;margin-left:" + b + "px;margin-top:" + c + "px' class='popup_block'>   <div onclick=\"$('#ModalWindowOuter" + e + "').remove()\" style='margin-left:" + (b - 15) + "px;margin-top:" + (c - 15) + "px' class='popup_close' ></div>   <iframe style='overflow:auto;width:" + g + "px;height:" + a + "px;margin-left:" + b + "px;margin-top:" + c + 'px\' class=\'popup_inside\' frameborder="0" scrolling="auto" src="' + f + '"></iframe></div>';
...
function ShowMenuIcon(b) {
    var a = "";
    if (b == 1) {
        a = '<a class="TopIcon" href="/Loader.aspx?ParTree=151915" id="pull" desc="نمايش فهرست, دسترسي به ساير خدمات سايت" onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()">نمايش فهرست</a>'
    }
    a += '<a class="TopIcon" href="http://en.tsetmc.com/" id="lang" desc="Languages, View tsetmc.com in Other Languages" onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()"></a><a class="TopIcon" href="http://www.tsetmc.com/Loader.aspx?ParTree=15" id="home" desc="خانه,دسترسي سريع به صفحه اول سايت شامل اطلاعات بازار بورس، فرابورس ..." onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()"></a><a class="TopIcon" href="http://www.tsetmc.com/Loader.aspx?ParTree=15131F" id="mwp" desc="ديده بان بازار, نمايش معاملات و درخواست هاي خريد و فروش. با امکان تغيير چيدمان و امکان ساخت سبد سهام" onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()"></a><a class="TopIcon" href="javascript:ShowSearchWindow()" id="search" desc="جستجوي نماد,براي جستجوي نمادها و شرکت ها. دسترسي سريع با کليد \'/\'  يا \'?\'" onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()"></a><a class="TopIcon" href="http://members.tsetmc.com/Site.aspx?ParTree=151912" id="cmt" desc="نظر و پيش نهاد, در صورت مشاهده هر گونه ايراد و يا درخواست امکانات جديد با استفاده از اين بخش با ما در ارتباط باشيد." onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()"></a><a class="TopIcon" href="javascript:ShowHelpWindow(\'151711\',true)" id="book" desc="راهنما,آموزش امکانات سایت" onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()"></a><a class="TopIcon" href="javascript:ShowHelpWindow(\'1116\',false)" id="new" desc="اخبار,اخبار و تازه ها" onmouseover="ShowTooltip(this)" onmouseout="HideTooltip()"></a>';
    $("#menu_btns").html(a)
}

function CodalFilesWindow(d) {
    var c = '<div class="box3"><div class="header">' + d[3] + "</div><div class=\"content\" style=\"text-align:right\"><div style='display:inline-block'>زمان ارسال : </div><div style='display:inline-block' class='ltr'>" + d[4] + "</div><br/><div style='display:inline-block'>زمان انتشار : </div><div style='display:inline-block' class='ltr'>" + d[5] + "</div><br/>";
    if (d[7] == "2") {
        c += "<div class='CodalIcon CodalXls'/><a href='" + LongRunnigPagesSite + "/tsev2/data/CodalData.aspx?t=e&i=" + d[0] + "'>دریافت اطلاعیه با فرمت اکسل</a><div/>"
    }
    if (d[8] == "2") {
        c += "<div class='CodalIcon CodalPdf'/><a href='" + LongRunnigPagesSite + "/tsev2/data/CodalData.aspx?t=p&i=" + d[0] + "'>دریافت اطلاعیه با فرمت پی دی اف</a><div/>"
    }
    c += "</ul></div></div>";
    if (d[10].length != 0) {
        ...
        for (ipos = 0; ipos < a.length; ipos++) {
            ...
            c += "<div class='CodalIcon " + b + "'/><a href='" + LongRunnigPagesSite + "/tsev2/data/CodalData.aspx?t=a&i=" + d[0] + "&i2=" + a[ipos][0] + "'>" + a[ipos][2] + "</a><div/>"
        }
        c += "</div></div>"
    }
...
var RainbowColor = ["red", "green", "orange", "blue", "yellow", "indigo", "violet", "lightslategray", "crimson", "peru", "teal", "lime", "darkred", "torquoise", "pink"];
var RainbowColorFara = ["yellow", "orange", "red", "green", "blue", "indigo", "violet", "lightslategray", "crimson", "peru", "teal", "lime", "darkred", "torquoise", "pink"];

function DrawRainbowTab(a) {
    var f = a.tabName;
    var g = a.tabPlace;
    var c = a.RememberLastTab;
    var e = "";
    var b;
    if (f != "basemarket") {
        for (b = 0; b < a.item.length; b++) {
            e += "<li style='cursor:pointer' onclick='ShowRainbowTab(\"" + f + '",' + b + ',"' + a.item[b].RelatedElement + '","' + a.item[b].OnShowFunction.replace(/\'/g, "\\'").replace(/\"/g, '\\"') + '",' + c + ")' ><a id='rainbow_" + f + "_" + b + "' class='" + RainbowColor[a.firstColor + b] + " rainbow_" + f + (b == 0 ? " rainbowActive" : "") + "' >" + a.item[b].Title + "</a></li>"
        }
    } else {
        for (b = 0; b < a.item.length; b++) {
            e += "<li style='cursor:pointer' onclick='ShowRainbowTab(\"" + f + '",' + b + ',"' + a.item[b].RelatedElement + '","' + a.item[b].OnShowFunction.replace(/\'/g, "\\'").replace(/\"/g, '\\"') + '",' + c + ")' ><a id='rainbow_" + f + "_" + b + "' class='" + RainbowColorFara[a.firstColor + b] + " rainbow_" + f + (b == 0 ? " rainbowActive" : "") + "' >" + a.item[b].Title + "</a></li>"
        }
    }
    $(g).append('<div class="menuHolder2"><ul class="menu2">' + e + "</ul></div>");
    var d = localStorage.getItem("Rainbow_" + f + "_SelTab");
    if (d == null) {
        d = 0
    } else {
        d = parseInt(d)
    }
    ShowRainbowTab(f, d, a.item[d].RelatedElement, a.item[d].OnShowFunction, 0)
}
...
function MembersSite() {
    return "http://" + location.host.replace("www.", "members.")
}

function CdnSite() {
    return "http://" + location.host.replace("www.", "cdn.")
}
        ...
        success: function (e) {
            ...
            if (a) {
                for (var f = jdata.length - 1; f >= 0; f--) {
                    jtop += "<li onclick='ShowHelpTopic(" + d + "," + f + ")' class='top'>" + jdata[f].Lnk + "</li>"
                }
            } else {
...
function ShowHelpTopic(c, b) {
    ...
    var a = "";
    if (b != 0) {
        a += "<div class='flash' style='cursor:pointer;-webkit-transform:rotate(90deg);transform:rotate(90deg);' onclick='ShowHelpTopic(" + c + "," + (b - 1) + ")' >&nbsp;</div>"
    } else {
        a += "<div class='flash' style='-webkit-transform:rotate(90deg);transform:rotate(90deg);opacity:0.1;filter:alpha(opacity=10);'>&nbsp;</div>"
    }
    a += "<div class='flash' style='cursor:pointer;' onclick='ShowHelpTopic(" + c + ",-1)'>&nbsp;</div>";
    if (b != jdata.length - 1) {
        a += "<div class='flash' style='cursor:pointer;-webkit-transform:rotate(-90deg);transform:rotate(-90deg);' onclick='ShowHelpTopic(" + c + "," + (b + 1) + ")'>&nbsp;</div>"
    } else {
        a += "<div class='flash' style='-webkit-transform:rotate(-90deg);transform:rotate(-90deg);opacity:0.1;filter:alpha(opacity=10);'>&nbsp;</div>"
...
function MarketOverall() {
    var MarketOverall = {
            ...
            switch (TabName) {
                ...
                case "ime":
                    ...
                    if (document.getElementById("ImeTab1Elm").innerHTML.length == 0) {
                        ...
                        $.ajax({
                            url: "Loader.aspx?Partree=151317&Type=AgriculturalMercantile&Flow=1",
                            async: false,
                            cache: true,
                            dataType: "text",
                            success: function (data) {
        ...
        FundDetail: function (ProwId, PcellId) {
            window.open("http://www.tsetmc.com/Loader.aspx?ParTree=151324&i=" + ProwId, "_blank")
        },
        UpdateIme: function () {
...
(function () {
    ...
    function g() {
        ...
        var k = $.ajax({
            ...
            error: function (m) {
                var l = new Date(k.getResponseHeader("Date")) - (new Date()) + ((new Date()) - j) / 2;
                if (e++ < 3 && ((new Date()) - j > a || k.getResponseHeader("Date") == null)) {
                    g()
                } else {
                    if (e >= 3) {
                        h = 1000 * 10
